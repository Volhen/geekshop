...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = GeekUser.objects.create_superuser('django2',
                                                           'django2@geekshop.local',
                                                           'geekbrains')

        self.user = GeekUser.objects.create_user('tarantino',
                                                 'tarantino@geekshop.local',
                                                 'geekbrains')

        self.user_with__first_name = GeekUser.objects.create_user('umaturman',
    ...
    def test_user_register(self):
        ...
        new_user = GeekUser.objects.get(username=new_user_data['username'])
